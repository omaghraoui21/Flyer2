...
## Livrables
- `Paletto_Studio_Flyer_Print.pdf` : PDF 2 pages, 154 x 216 mm (A5 + 3 mm de fond perdu), RVB, polices incorporées.
...
## Impression
- Format de page : 154 x 216 mm, coupe A5 148 x 210 mm centrée, 3 mm de fond perdu sur les 4 côtés.
